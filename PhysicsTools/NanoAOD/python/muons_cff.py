...
muonTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(CandVars,
        ...
        timeAtIpInOut    = Var("time().timeAtIpInOut",    float, doc="Muon time at IP in/out",    precision=23),
        timeAtIpInOutErr = Var("time().timeAtIpInOutErr", float, doc="Uncertainty on timeAtIpInOut", precision=23),
        timeAtIpOutIn    = Var("time().timeAtIpOutIn",    float, doc="Muon time at IP out/in",    precision=23),
        timeAtIpOutInErr = Var("time().timeAtIpOutInErr", float, doc="Uncertainty on timeAtIpOutIn", precision=23),
        rpcTimeAtIpInOut    = Var("rpcTime().timeAtIpInOut",    float, doc="RPC Muon time at IP in/out",    precision=23),
        rpcTimeAtIpInOutErr = Var("rpcTime().timeAtIpInOutErr", float, doc="RPC Uncertainty on timeAtIpInOut", precision=23),
        rpcTimeAtIpOutIn    = Var("rpcTime().timeAtIpOutIn",    float, doc="RPC Muon time at IP out/in",    precision=23),
        rpcTimeAtIpOutInErr = Var("rpcTime().timeAtIpOutInErr", float, doc="RPC Uncertainty on timeAtIpOutIn", precision=23),
        isTimeValid = Var("isTimeValid()", bool, doc="Time measurement is valid"),
        inverseBeta = Var("inverseBeta()", float, doc="1/beta", precision=23),
        inverseBetaErr = Var("inverseBetaErr()", float, doc="1/beta error", precision=23),
