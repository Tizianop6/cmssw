...
muonTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(CandVars,
        ...
        timeAtIpInOut    = Var("time().timeAtIpInOut",    float, doc="Muon time at IP in/out",    precision=6),
        timeAtIpInOutErr = Var("time().timeAtIpInOutErr", float, doc="Uncertainty on timeAtIpInOut", precision=6),
        timeAtIpOutIn    = Var("time().timeAtIpOutIn",    float, doc="Muon time at IP out/in",    precision=6),
        timeAtIpOutInErr = Var("time().timeAtIpOutInErr", float, doc="Uncertainty on timeAtIpOutIn", precision=6),
        rpcTimeAtIpInOut    = Var("rpcTime().timeAtIpInOut",    float, doc="RPC Muon time at IP in/out",    precision=6),
        rpcTimeAtIpInOutErr = Var("rpcTime().timeAtIpInOutErr", float, doc="RPC Uncertainty on timeAtIpInOut", precision=6),
        rpcTimeAtIpOutIn    = Var("rpcTime().timeAtIpOutIn",    float, doc="RPC Muon time at IP out/in",    precision=6),
        rpcTimeAtIpOutInErr = Var("rpcTime().timeAtIpOutInErr", float, doc="RPC Uncertainty on timeAtIpOutIn", precision=6),
