...
private:
  ...
  MonitorElement* meNoPIDTrackResNoPIDType_[3];
  ...
  MonitorElement* meNoPIDTrackPullNoPIDType_[3];
...
void Primary4DVertexValidation::bookHistograms(DQMStore::IBooker& ibook,
  ...
  if (optionalPlots_) {
    ...
    meNoPIDTrackResNoPIDType_[0] = ibook.book1D("NoPIDTrackResNoPIDType1",
                                              "Time residual of no PID tracks, no PID type 1; t_{rec} - t_{sim} [ns];",
                                                100,
                                                -5.,
                                                5.);
                                                
    meNoPIDTrackResNoPIDType_[1] = ibook.book1D("NoPIDTrackResNoPIDType2",
                                                "Time residual of no PID tracks, no PID type 2; t_{rec} - t_{sim} [ns];",
                                                100,
                                                -5.,
                                                5.);
    meNoPIDTrackResNoPIDType_[2] = ibook.book1D("NoPIDTrackResNoPIDType3",
    ...
    meNoPIDTrackPullNoPIDType_[0] = ibook.book1D("NoPIDTrackPullNoPIDType1",
                                               "Time pull of no PID tracks, no PID type 1; (t_{rec} - t_{sim})/#sigma_{t rec}; ",
                                                100,
                                                -10.,
                                                10.);
    meNoPIDTrackPullNoPIDType_[1] = ibook.book1D("NoPIDTrackPullNoPIDType2",
                                                "Time pull of no PID tracks, no PID type 2; (t_{rec} - t_{sim})/#sigma_{t rec}; ",
                                                100,
                                                -10.,
                                                10.);
    meNoPIDTrackPullNoPIDType_[2] = ibook.book1D("NoPIDTrackPullNoPIDType3",
          ...
          if (tp_info != nullptr && matchCategory == 0) {
            ...
            if (selectRecoTrk && optionalPlots_) {
              ...
              if (no_PID){
                ...
                if (no_PIDtype == 1) {
                  meNoPIDTrackResNoPIDType_[0]->Fill(t0Safe[*iTrack] - tsim);
                  meNoPIDTrackPullNoPIDType_[0]->Fill((t0Safe[*iTrack] - tsim) / sigmat0Safe[*iTrack]);
                  ...
                  meNoPIDTrackResNoPIDType_[1]->Fill(t0Safe[*iTrack] - tsim);
                  meNoPIDTrackPullNoPIDType_[1]->Fill((t0Safe[*iTrack] - tsim) / sigmat0Safe[*iTrack]);
                  ...
                  meNoPIDTrackResNoPIDType_[2]->Fill(t0Safe[*iTrack] - tsim);
                  meNoPIDTrackPullNoPIDType_[2]->Fill((t0Safe[*iTrack] - tsim) / sigmat0Safe[*iTrack]);
